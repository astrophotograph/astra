...
const CATALOG_SOURCES = {
  ...
  messier: {
    id: "messier",
    name: "Messier",
    url: `${import.meta.env.BASE_URL}catalogs/Messier.json`,
    color: "#29a329",
    type: "json" as const,
  },
  ngc: {
    id: "ngc",
    name: "NGC",
    url: `${import.meta.env.BASE_URL}catalogs/OpenNGC.json`,
    color: "#cccccc",
    type: "json" as const,
  },
  ic: {
    id: "ic",
    name: "IC",
    url: `${import.meta.env.BASE_URL}catalogs/OpenIC.json`,
    color: "#aaaaaa",
    type: "json" as const,
  },
  sharpless: {
    id: "sharpless",
    name: "Sharpless",
    url: `${import.meta.env.BASE_URL}catalogs/Sharpless.json`,
    color: "#00afff",
    type: "json" as const,
  },
  ldn: {
    id: "ldn",
    name: "LDN",
    url: `${import.meta.env.BASE_URL}catalogs/LDN.json`,
    color: "#CBCC49",
    type: "json" as const,
  },
  lbn: {
    id: "lbn",
    name: "LBN",
    url: `${import.meta.env.BASE_URL}catalogs/LBN.json`,
    color: "#CBCC49",
    type: "json" as const,
  },
  barnard: {
    id: "barnard",
    name: "Barnard",
    url: `${import.meta.env.BASE_URL}catalogs/Barnard.json`,
    color: "#E0FFFF",
    type: "json" as const,
  },
} as const;
