    ...
    try:
        ...
        for obj in objects:
            ...
            try:
                ...
                # The raw WCS from solve-field maps directly to the FITS pixel
                # layout. No flipping needed — the CD matrix encodes the full
                # orientation including any mirror from optics or storage order.
