    ...
    try:
        ...
        for obj in objects:
            ...
            try:
                ...
                # The WCS from solve-field maps sky coords to the pixel layout
                # of the image as it was solved — no flipping needed. The CD
                # matrix already encodes any mirror flips from optics
                # (Newtonian vs refractor) or storage order (TOP-DOWN).
